...
(4, '2021_04_04_083537_create_questions_table', 1);
...
INSERT INTO `questions` (`id`, `question`, `ans`, `option1`, `option2`, `option3`, `option4`, `created_at`, `updated_at`) VALUES
(1, 'my name is ?', '1', 'a', 'b', 'c', 'd', NULL, NULL),
(3, 'Where are you from ?', '2', 'a', 'b', 'c', 'd', NULL, NULL);
...
INSERT INTO `result` (`id`, `user_value`, `qn_id`) VALUES
(1, 1, 1),
(2, 2, 3);
